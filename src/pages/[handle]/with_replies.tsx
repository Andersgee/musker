...
import { useProfileTweetsWithRepliesList } from "src/hooks/useInfiniteList";
...
const Page: NextPage<Props> = ({ user }) => {
  ...
  const { tweetsAndRetweets, ref, isFetchingNextPage } = useProfileTweetsWithRepliesList(!router.isFallback, user?.id);
